<template>
  <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
      <div class="main-left col-span-1">
          <div class="p-4 bg-white border border-gray-200 rounded-lg">
              <div class="space-y-4">
                  <div 
                      class="flex items-center justify-between p-2 m-2"
  ...
  <form @submit.prevent="submitForm" class="p-4">
    ...
    <!-- Textarea Input -->
    <div class="mb-4">
      <textarea v-model="body" class="w-full p-4 bg-gray-100 rounded-lg" placeholder="What do you want to say?"></textarea>
    </div>

    <!-- Submit Button with SVG Icon -->
    <div class="flex justify-end">
      <button class="px-6 py-4 bg-blue-600 text-white rounded-full flex items-center space-x-2">
